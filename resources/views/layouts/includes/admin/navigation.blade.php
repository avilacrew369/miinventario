 <nav class="fixed top-0 z-50 w-full bg-neutral-primary-soft border-b border-default bg-white">
         ...
         <div class="flex items-center justify-between">
             <div class="flex items-center justify-start rtl:justify-end">
                 ...
                 <a href="/" class="flex ms-2 md:me-24">
                     <img src="/panther.jpg" class="h-10  rounded-lg me-3" alt="FlowBite Logo" />
                     <span class="self-center text-lg font-semibold whitespace-nowrap dark:text-blue-500">Digital Solutions</span>
                 </a>
             </div>
